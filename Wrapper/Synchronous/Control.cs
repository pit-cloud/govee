...
namespace PowerIT.Govee
{
    ...
    {
        public static Models.Control.Response On(string deviceId, string model)
        {
            if (Account.IsLoggedIn)
            {
                ...
                HttpResponseMessage response = client.PutAsync("devices/control", content).Result;
        ...
        public static Models.Control.Response Off(string deviceId, string model)
        {
            if (Account.IsLoggedIn)
            {
                if (string.IsNullOrEmpty(deviceId))
        ...
        public static Models.Control.Response Brightness(string deviceId, string model, int brightness)
        {
            if (Account.IsLoggedIn)
            {
                if (string.IsNullOrEmpty(deviceId))
        ...
        public static Models.Control.Response Temprature(string deviceId, string model, int temprature)
        {
            if (Account.IsLoggedIn)
            {
                if (string.IsNullOrEmpty(deviceId))
        ...
        public static Models.Control.Response Color(string deviceId, string model, Color color)
        {
            if (Account.IsLoggedIn)
            {
                if (string.IsNullOrEmpty(deviceId))
